...
- 🟡 ⬜ **GrowPod University v2 — research foundation** (2026-06-14, Directive UNI-001) — a 10-agent
  ...
  **Foundations ratified as UNI-ADR-001** (2026-06-14, `DECISIONS.md`): rewards NON-GROW only;
  Doctorate = Master's+thesis AND (Cup-placement | Legendary cultivar | new mutation | genetics
  contribution); quizzes a **required ≥70% gate**; structured-only social V1; monetization parked;
  merit prestige ladder Seedling→…→Doctorate. **Build is post-MVP** (after the Graphics→MVP track).
